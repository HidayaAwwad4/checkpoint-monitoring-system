...
object MessageAnalyzer {
  ...
  private val checkpointNames = Map(
    ...
    "قلنديا" -> "qalandia", "قلنديه" -> "qalandia", "عطارة" -> "atara", "عطاره" -> "atara",
    "جبع" -> "jaba", "جباع" -> "jaba", "سلواد" -> "silwad", "سلواد الجسر" -> "silwad_bridge",
    "عين سينيا" -> "ein_sinia", "عين سينيه" -> "ein_sinia", "بيتونيا" -> "beitunia", "بيتونيه" -> "beitunia",
    "بيت ايل" -> "beit_el", "بيت إيل" -> "beit_el", "الجلزون" -> "jalazone", "الجلزونه" -> "jalazone",
    "كفر عقب" -> "kafr_aqab", "كفرعقب" -> "kafr_aqab", "الرام" -> "al_ram", "الرامه" -> "al_ram",
    "بير نبالا" -> "bir_nabala", "بيرنبالا" -> "bir_nabala", "بدو" -> "bidu", "بيدو" -> "bidu",
    "النبي صالح" -> "nabi_saleh", "نبي صالح" -> "nabi_saleh", "قبيه" -> "qibya", "قبيا" -> "qibya",
    "دير نظام" -> "deir_nizam", "ديرنظام" -> "deir_nizam", "بوابة رام الله" -> "ramallah_gate",
    "رام الله" -> "ramallah", "البيرة" -> "al_bireh", "البيره" -> "al_bireh",

    // منطقة نابلس
    "حوارة" -> "huwwara", "حواره" -> "huwwara", "حواريه" -> "huwwara",
    "زعترة" -> "zaatara", "زعتره" -> "zaatara", "زعتارة" -> "zaatara",
    "بيت فوريك" -> "beit_furik", "بيتفوريك" -> "beit_furik", "عوريتا" -> "awarta", "عورتا" -> "awarta",
    "يتسهار" -> "yitzhar", "يتسهارالجنوبي" -> "yitzhar_south", "يتسهارالشمالي" -> "yitzhar_north",
    "شافي شمرون" -> "shavei_shomron", "شافيشمرون" -> "shavei_shomron",
    "دير شرف" -> "deir_sharaf", "ديرشرف" -> "deir_sharaf", "تل" -> "tell", "تلالغربي" -> "tell_west",
    "سبسطية" -> "sebastia", "سبسطيه" -> "sebastia", "عصيرة الشمالية" -> "asira_north",
    "جيت" -> "jit", "جيتالشمالي" -> "jit_north", "عزموط" -> "azmut", "عزموطالجنوبي" -> "azmut_south",

    // منطقة قلقيلية وطولكرم
    "عزون عتمة" -> "azzun_atma", "عزونعتمة" -> "azzun_atma", "عزون" -> "azzun",
    "الطيبة" -> "taybeh", "الطيبه" -> "taybeh", "قلقيلية" -> "qalqilya", "قلقيليه" -> "qalqilya",
    "كفر قاسم" -> "kafr_qasem", "كفرقاسم" -> "kafr_qasem", "حبلة" -> "habla", "حبله" -> "habla",
    "جيوس" -> "jayous", "جيوسالشرقي" -> "jayous_east", "الفندق" -> "al_funduq", "الفندقومه" -> "al_funduq",
    "عنبتا" -> "anabta", "عنبته" -> "anabta", "الكفريات" -> "kafryat", "الكفرياتالشرقي" -> "kafryat_east",
    "دير الغصون" -> "deir_al_ghasoun", "ديرالغصون" -> "deir_al_ghasoun",

    // منطقة جنين
    "الجلمة" -> "jalama", "الجلمه" -> "jalama", "جلمة" -> "jalama",
    "عرابة" -> "arraba", "عرابه" -> "arraba", "الطيبون" -> "al_tayboun", "الطيبونالجنوبي" -> "al_tayboun_south",
    "مثلث الشهداء" -> "martyrs_triangle", "مثلثالشهداء" -> "martyrs_triangle",
    "ريحان" -> "rihan", "ريحانالغربي" -> "rihan_west", "بارطعة" -> "bartaa", "بارطعه" -> "bartaa",
    "دوتان" -> "dotan", "دوتانالشرقي" -> "dotan_east", "زبوبا" -> "zabuba", "زبوبه" -> "zabuba",

    // منطقة سلفيت
    "دير بلوط" -> "deir_ballut", "ديربلوط" -> "deir_ballut", "كفل حارس" -> "kafr_haris",
    "بروقين" -> "bruqin", "بروقينالشرقي" -> "bruqin_east", "قراوة بني حسان" -> "qarawat_bani_hassan",
    "كفر الديك" -> "kafr_al_dik", "كفرالديك" -> "kafr_al_dik", "ياسوف" -> "yasuf", "ياسوفالشمالي" -> "yasuf_north",

    // منطقة بيت لحم والخليل
    "بيت لحم" -> "bethlehem", "بيتلحم" -> "bethlehem", "الكونتينر" -> "container", "الكونتينرالجنوبي" -> "container_south",
    "حاجز النفق" -> "tunnel_checkpoint", "النفق" -> "tunnel_checkpoint", "النفق الجنوبي" -> "tunnel_south",
    "الخليل" -> "hebron", "الخليل الشمالي" -> "hebron_north", "كريات أربع" -> "kiryat_arba",
    "العروب" -> "arroub", "العروب الشمالي" -> "arroub_north", "العروب الجنوبي" -> "arroub_south",
    "بيت عينون" -> "beit_einun", "بيتعينون" -> "beit_einun", "سعير" -> "sair", "سعيرالشمالي" -> "sair_north",
    "الفوار" -> "al_fawar", "الفوارالجنوبي" -> "al_fawar_south", "مفترق الشيوخ" -> "al_shuyukh_junction",
    "الظاهرية" -> "dhahiriya", "الظاهريه" -> "dhahiriya", "شويكة" -> "shweika", "شويكه" -> "shweika",
    "تفوح" -> "taffuh", "تفوحالغربي" -> "taffuh_west", "بيت أمر" -> "beit_ummar", "بيتأمر" -> "beit_ummar",
    "حلحول" -> "halhul", "حلحولالشمالي" -> "halhul_north", "قبة النصر" -> "qubbet_al_nasr",

    // منطقة أريحا والأغوار
    "معبر الكرامة" -> "allenby_bridge", "الكرامة" -> "allenby_bridge", "معبرالكرامة" -> "allenby_bridge",
    "معاليه أدوميم" -> "maaleh_adumim", "معاليهأدوميم" -> "maaleh_adumim",
    "الحمرا" -> "al_hamra", "الحمراالشمالي" -> "al_hamra_north", "الحمره" -> "al_hamra",
    "الأغوار" -> "jordan_valley", "الأغوارالشمالية" -> "jordan_valley_north",
    "طيبة" -> "tayibe", "طيبه" -> "tayibe", "عين الديوك" -> "ein_al_dyuk",

    // حواجز رئيسية أخرى
    "الإسكانات نصار" -> "iskanat_nssar", "نصار" -> "iskanat_nssar", "الإسكانات نصار" -> "iskanat_nssar",
    "بوابة فوق الجسر" -> "bridge_gate", "بوابةفوقالجسر" -> "bridge_gate", "الجسر" -> "bridge",
    "دوار قدوميم" -> "qedumin_roundabout", "قدوميم" -> "qedumin", "دوارقدوميم" -> "qedumin_roundabout",
    "مدخل أماتين" -> "amatain_entrance", "أماتين" -> "amatain", "مدخلأماتين" -> "amatain_entrance",
    "البوابة" -> "al_bawaba", "بوابة" -> "gate", "بوابه" -> "gate",
    "بوالة" -> "bwala", "بواله" -> "bwala", "سنجل" -> "sinjil", "سنجل الشمالي" -> "sinjil_north",
    "ترمسعيا" -> "turmus_ayya", "ترمسعياالغربي" -> "turmus_ayya_west",
    "بيرود" -> "birud", "بيرودالشرقي" -> "birud_east", "المعالي" -> "al_maali", "المعاليالجنوبي" -> "al_maali_south",
    "عابود" -> "aboud", "عابودالشمالي" -> "aboud_north", "المربعة" -> "al_murabba", "المربعه" -> "al_murabba",
    "عناب" -> "annab", "عنابالشمالي" -> "annab_north", "كفر قدوم" -> "kafr_qaddum",
    "نعلين" -> "naalin", "نعلين الغربي" -> "naalin_west", "بيلين" -> "bilin", "بيلينالشرقي" -> "bilin_east",
    "قدوم" -> "qaddum", "قدوم الشمالي" -> "qaddum_north", "عقبة حسنة" -> "aqaba_hasna", "عقبة حسنه" -> "aqaba_hasna"
  )
